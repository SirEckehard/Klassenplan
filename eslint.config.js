...
const UI_ALGORITHM_MESSAGE =
  'UI-Code erreicht "@/utils/algorithm" über Hooks und Contexts. Erlaubt sind Typ-Importe sowie seatingStatistics, criterionHighlights, planReasons und circleSummary (siehe docs/MODULE_BOUNDARIES.md).';
