...
export default function ModeSelect({
  ...
  const modeCardClass = `${cardSurfaceClass} group flex w-full max-w-sm cursor-pointer flex-col items-center gap-3 p-8 text-center transition hover:-translate-y-1 hover:shadow-xl focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-(--focus-ring-primary) motion-reduce:transition-none motion-reduce:hover:translate-y-0`;
