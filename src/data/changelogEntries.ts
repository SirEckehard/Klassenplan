...
export const changelogVersions: ChangelogVersion[] = [
  {
    ...
    date: '2026-09-16',
    changes: [
      { textKey: 'v2_1_0.0', type: 'feature' },
      { textKey: 'v2_1_0.1', type: 'feature' },
      { textKey: 'v2_1_0.2', type: 'improvement' },
      { textKey: 'v2_1_0.3', type: 'improvement' },
      { textKey: 'v2_1_0.4', type: 'improvement' },
    ],
  },
  {
    version: '2.0.4',
  ...
  },
  {
    ...
    date: '2026-09-08',
    changes: [
      { textKey: 'v2_0_3.0', type: 'improvement' },
      { textKey: 'v2_0_3.1', type: 'bugfix' },
      { textKey: 'v2_0_3.2', type: 'bugfix' },
      { textKey: 'v2_0_3.3', type: 'bugfix' },
      { textKey: 'v2_0_3.4', type: 'bugfix' },
      { textKey: 'v2_0_3.5', type: 'bugfix' },
      { textKey: 'v2_0_3.6', type: 'bugfix' },
      { textKey: 'v2_0_3.7', type: 'bugfix' },
    ],
  },
  {
    version: '2.0.2',
    date: '2026-09-05',
    changes: [
      { textKey: 'v2_0_2.0', type: 'bugfix' },
      { textKey: 'v2_0_2.1', type: 'bugfix' },
    ],
  },
  {
    version: '2.0.1',
    date: '2026-09-05',
    changes: [
      { textKey: 'v2_0_1.0', type: 'feature' },
      { textKey: 'v2_0_1.1', type: 'feature' },
      { textKey: 'v2_0_1.2', type: 'feature' },
      { textKey: 'v2_0_1.3', type: 'feature' },
      { textKey: 'v2_0_1.4', type: 'improvement' },
      { textKey: 'v2_0_1.5', type: 'improvement' },
      { textKey: 'v2_0_1.6', type: 'improvement' },
      { textKey: 'v2_0_1.7', type: 'improvement' },
      { textKey: 'v2_0_1.8', type: 'improvement' },
      { textKey: 'v2_0_1.9', type: 'improvement' },
      { textKey: 'v2_0_1.10', type: 'improvement' },
      { textKey: 'v2_0_1.11', type: 'improvement' },
      { textKey: 'v2_0_1.12', type: 'improvement' },
      { textKey: 'v2_0_1.13', type: 'bugfix' },
      { textKey: 'v2_0_1.14', type: 'bugfix' },
    ],
  },
  {
    version: '2.0.0',
