...
export const WhoIsNext = lazyWithRetry(() => import('@/pages/WhoIsNext'));
export const SeatFinder = lazyWithRetry(() => import('@/pages/SeatFinder'));
export const Groups = lazyWithRetry(() => import('@/pages/Groups'));
